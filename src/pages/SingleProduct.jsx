...
const SingleProduct = () => {
  ...
  useEffect(() => {
    if (Array.isArray(data) && data.length > 0) {
      // ✅ safeguard for undefined products
  ...
  return (
    <div className="px-4 pb-4 md:px-0">
      ...
      <div className="max-w-6xl mx-auto md:p-6 grid sm:grid-cols-1 md:grid-cols-2 gap-10">
        {/* Product Image */}
        <div className="w-full">
          <img
            src={singleProduct.image}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-gray-600">
            {singleProduct.brand?.toUpperCase() || "UNKNOWN BRAND"} /{" "}
            {singleProduct.category?.toUpperCase() || "MISC"}
          </div>
